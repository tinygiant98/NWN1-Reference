...
void main()
{
  ...
  string sMenuMillStaples = CnrRecipeAddSubMenu("cnrFarmersMill", "Staples");

  sKeyToRecipe = CnrRecipeCreateRecipe(sMenuMillStaples, "Sugar", "cnrSugar", 1);
  CnrRecipeAddComponent(sKeyToRecipe, "cnrCaneRaw", 2);
